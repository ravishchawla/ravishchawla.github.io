window.onload = function() {
	//loadProjects();
		...
		document.getElementById('footer').innerHTML = '<div align="center" class="container"><h4><small>Hosted at Github. <br> Copyright © Ravish Chawla 2014.</small></h4></div>';
...
loadName = function() {
 var name = "Ravish Chawla";
 document.getElementById("name").innerHTML = name;
 }
 
loadDescription = function() {
 var description = "Lorizzle ipsizzle dolizzle gangsta amet, phat adipiscing elizzle. Fo shizzle sapizzle velizzle, uhuh ... yih! volutpizzle, suscipizzle quis, nizzle vel, arcu. Pellentesque eget shiznit. Sed eros. Fusce izzle gangsta dapibus phat tempizzle sheezy. Maurizzle you son of a bizzle nibh et boofron. Get down get down izzle tortor. Rizzle mammasay mammasa mamma oo sa rhoncizzle break yo neck, yall. Phat own yo' stuff shiznit dictumst. Boofron dapibizzle. My shizz tellizzle pimpin', pretizzle ghetto, mattizzle ac, get down get down dawg, nunc. Shit suscipizzle. Sure dope ghetto sizzle hizzle.";
